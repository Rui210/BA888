...
ggplot(new_table, aes(x=stars)) +
  geom_histogram(stat="count",fill = "#F15C4F") +
  labs(title="Checkins by Star Ratings")+
  theme_classic() +
  labs(title="Distribution of Star Ratings", x = "Star Rating", y = "# of Restaurants") +
   theme(axis.text = element_text(size = 13)) +
  theme(axis.title = element_text(size = 13)) 
...
ggplot(restaurants)+
  ...
  labs(title="Distribution of star ratings by City", x = "City", y = "Number of Restaurants") +
