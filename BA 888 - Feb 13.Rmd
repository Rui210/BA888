...
### Data Source   
We got our data from Kaggle, and there are 4 datasets in total, namely, resuaurant and business,users,and checkin.
...
ggplot(res)+
  ...
  labs(title="Price Rnage for Star Restaurants",
       x="Resaurant Price Range",
       y="The number of each stars")
```
